...
- **Permanent MR limitation:** The exact submitted-table DD SNP-level run remains unavailable. A separately labelled current targeted follow-up for the final 29 traits supplies harmonised instruments, pleiotropy and sensitivity estimators for all 58 exposure-outcome pairs; it is not claimed as an exact reconstruction of the lost historical run.
