# Independent audit of the corrected Granger analysis and Figure 5
...
3. **The figure footer and legend use an ambiguous denominator.** “Residual serial-correlation flags occurred in 84/204 models” actually means 84 of 204 country analyses had a flag in at least one of two directional equations; 90 of 408 individual directional equations were flagged. Replace this with the exact wording. Likewise, “influential observations occurred in all 204” can be made precise: all 408 directional equation fits exceeded the stated Cook's-distance threshold for at least one observation. This is a reporting defect, not a numerical defect.
...
## Figure 5 source, geometry, and visual audit
...
- Primary q values are identical to Supplementary Table S2. Independently recomputed HC3 q values matched the figure source within 5.6e-16. Panel counts and legend counts are correct.
...
- PNG and TIFF are both 3600 x 2550 pixels; the PNG metadata is approximately 300 dpi. PDF and SVG vector outputs are present and checksum-bound.
- Visual inspection of the full-size PNG found no clipped title, subtitle, maps, points, legends, or footer; panel labels A/B are present and colors are distinguishable. The coordinate-point representation makes small islands visible, although dense regions necessarily contain overlapping points. The figure clearly states ecological temporal prediction rather than individual or mechanistic causation.
- The visual hierarchy still privileges the unstable Newey–West result by calling it “Primary temporal predictive associations.” For claim calibration, relabel it as a named specification (for example, “Newey–West(2) inference”) and make the cross-estimator instability the leading result, or move the figure to supplementary material.
