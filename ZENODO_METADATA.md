...
- **Description:** This archive contains analysis scripts, derived outputs, figure-source material, software records, checksums, and step-by-step access instructions supporting the study. Version 1.1.0 adds the completed targeted 29-trait × two-outcome instrument-level sensitivity analysis and the verified GBD preprocessing chain, while retaining explicit historical provenance limitations.
...
- **GitHub source release:** https://github.com/casper4869/IHD-DD-reproducibility/releases/tag/v1.1.0
