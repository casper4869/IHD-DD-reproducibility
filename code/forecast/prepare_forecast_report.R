# INTERNAL POST-SUBMISSION FORECAST AUDIT ONLY; generated prose and display are not manuscript replacements.
...
report <- c(
  ...
  "> **Scope:** Post-submission internal audit/sensitivity only. This report does not describe or replace the manuscript Figure 4.", "",
  "## Decision", "",
...
legend <- c("INTERNAL AUDIT/SENSITIVITY DISPLAY - NOT THE SUBMITTED MANUSCRIPT FIGURE 4.",
  "Figure 4 audit. Sensitivity of projected numbers of countries with co-high ischaemic heart disease and depressive disorder incidence.",
...
manuscript <- c("# Internal forecast-audit interpretation draft", "",
  "> **Scope:** Not approved manuscript text and not a replacement for the submitted Figure 4.", "",
  "## Results", "",
